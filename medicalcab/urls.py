"""
URL configuration for medicalcab project.
...
urlpatterns = [
    ...
    path('home/', cabinet.views.home, name='home'),
    path('page1/', cabinet.views.page1, name='page1'),
    path('signup/', authentication.views.signup_page, name='signup'),
    path('newdoctor/', cabinet.views.addnew_doctor, name='new-doctor'),
    path('newappointment/', cabinet.views.addnew_appointment, name='new-appointment'),
    path('newschedule/', cabinet.views.addnew_schedule, name='new-schedule'),
